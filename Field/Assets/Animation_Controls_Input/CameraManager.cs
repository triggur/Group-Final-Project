...
public class CameraManager : MonoBehaviour
{
    ...
    public float cameraLookSpeed = 0.25f;
    public float cameraPivotSpeed = 0.25f;

    // Camera Collision variables
    public float cameraCollisionRadius = 0.2f;
    public float cameraCollisionOffset = 0.2f; // how much the camera will jump off objects
    ...
    private void Awake()
    {
        inputManager = FindObjectOfType<ManageInput>();
        targetTransform = FindObjectOfType<ManagePlayer>().transform;
